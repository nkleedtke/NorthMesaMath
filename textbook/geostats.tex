...
The ``Geo-Stats'' course is a full-year course that covers geometry and statistics. Specifically, the course covers the standards outline included \href{web.ped.nm.gov}{here}. The material in this textbook was used for videos presented on North Mesa Math Youtube \href{youtube.com/@NorthMesaMath}{channel} (@NorthMesaMath). The work focuses on three specific student needs: (1) accessible content, (2) free resources, and (3) need-to-know concepts. All content provided on the North Mesa Math Youtube channel and GitHub \href{https://github.com/nkleedtke/NorthMesaMath/}{repository} is free and easily accesible. The figures showing output from a TI-84 calculator were produced using this free TI-84 emulator \href{https://ti84calc.com/ti84calc}{website}. Lastly, all material is tied to New Mexico state standards, such that each conceptual idea contributes to a specified knowledge need.

The textbook chapters are structured in 4 subsections: (1) warm-up, (2) examples, (3) exercises, and (4) cool-down. Each chapter is designed to provide students low-barrier-to-entry material to build confidence (warm-up), problems to confirm understanding (examples), problems to challenge mastery of the material (exercises), and a summary of key-takeaways to utilize in the subsequent chapter. This textbook is by no means fully comprehensive of all state-mandated standards. All feedback is welcome - If you want to contribute, please send a message to Noah Kleedtke (kleedtke@gmail.com). Enjoy!
...
Throughout this course you'll be tasked with answering questions related to various geometric shapes. Two of the most common shapes are the circle and the triangle. These shapes are shown in Figure.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/ct.png}
  \caption{Cricle and triangle.}
  \label{fig:shapes}
\end{figure} 
...
\begin{center}    
    ...
    P(X$\geq$10) = P(X=10) + P(X=11) + ... + P(X=30) \\
    ...
    P(X$\geq$10) = 1 - binomcdf(30,$\frac{1}{6}$,9) \\
     See Figure \ref{fig:ch9q1}.  2nd > distr > B:binomcdf(trials,p,x) \\
    P(X$\geq$10) = 1 - binomcdf(30,$\frac{1}{6}$,9) = 0.0197062838 \\
     Don't let your friends fool you. The probability of you rolling a 2 more than 10 times is very low, ~1.97\% to be exact. \\
\end{center}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.2\textwidth]{figures/ch9q1.png}
  \caption{Cricle and triangle.}
  \label{fig:ch9q1}
\end{figure} 
